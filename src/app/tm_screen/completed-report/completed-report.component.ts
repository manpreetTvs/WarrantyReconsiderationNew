...
@Component({
  standalone: true,
  selector: 'app-completed-report',
  templateUrl: './completed-report.component.html',
  styleUrls: ['./completed-report.component.css'],
  imports: [
    CommonModule,
    FormsModule,
    MatSelectModule,
...
export class CompletedReportComponent implements OnInit {
  ...
  ngOnInit(): void {
    // this.tmService.fetchOrderDetailsReports('F').subscribe((data)=> {
